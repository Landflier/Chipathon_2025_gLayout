  ...
  foreach var2 $&vg_vec
    ...
    foreach var3 $&vd_vec
      ...
      foreach var4 $&vb_vec
        alter vb $var4
        run
        wrdata techsweep_nfet_03v3_w_2um_nf_6.txt noise1.all
        destroy all
        set appendwrite
...
op
show
write techsweep_nfet_03v3_w_2um_nf_6.raw
.endc
"}
...
value="
.include /home/vasil/Downloads/SSCS_PICO_2025/src/jupyter_notebooks/gmId/gm-ID-gf180mcuD/starter_files_open_source_tools/gf180mcuD/models_updated_2025.07.19/ngspice/design.ngspice
.lib /home/vasil/Downloads/SSCS_PICO_2025/src/jupyter_notebooks/gmId/gm-ID-gf180mcuD/starter_files_open_source_tools/gf180mcuD/models_updated_2025.07.19/ngspice/sm141064.ngspice typical
"}
