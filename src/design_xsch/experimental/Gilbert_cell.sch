...
C {lab_wire.sym} 950 -970 0 0 {name=p12 sig_type=std_logic lab=GND}
C {lab_wire.sym} 800 -1150 0 0 {name=p13 sig_type=std_logic lab=GND}
C {lab_wire.sym} 1090 -1150 0 0 {name=p14 sig_type=std_logic lab=GND}
