...
sim_type=tran
rawfile=$netlist_dir/Gilbert_cell_tb_IIP3_sim.raw}
...
tclcommand="xschem raw_read $netlist_dir/Gilbert_cell_tb_IIP3_sim.raw"
}
C {lab_wire.sym} 120 -2010 0 0 {name=p8 sig_type=std_logic lab=V_LO}
C {lab_wire.sym} 200 -2010 0 0 {name=p9 sig_type=std_logic lab=V_LO_b
}
C {vdd.sym} 120 -1830 0 0 {name=l8 lab=VDD}
C {vsource.sym} 120 -1790 0 0 {name=V_PWR value=3.3 savecurrent=true}
C {title-2.sym} 0 0 0 0 {name=l9 author="Time Transcenders" lock=true rev=1.0 page=1}
C {vsource.sym} 120 -1960 0 0 {name=V_LO
* value="pulse(0 1.5 0 1p 1p 0.25n 0.5n)"
value="sin( 1 1 1 0 )"
savecurrent=true
hide_texts=true}
C {vsource.sym} 200 -1960 0 0 {name=V_LO_b
* value="pulse(0 1.5 0 1p 1p 0.25n 0.5n)"
value="sin( 1 1 1 0 )"
savecurrent=true
hide_texts=true}
C {vsource.sym} 70 -2170 0 0 {name=V_RF_tone_1
value="sin( 1 1 1 0 )"
savecurrent=true
hide_texts=false}
C {vsource.sym} 240 -2170 0 0 {name=V_RF_b_tone_1
value="sin( 1 1 1 0 0 180 )"
savecurrent=true
hide_texts=false}
C {gnd.sym} 120 -1740 0 0 {name=l7 lab=GND}
C {gnd.sym} 120 -1910 0 0 {name=l1 lab=GND}
C {gnd.sym} 200 -1910 0 0 {name=l2 lab=GND}
C {gnd.sym} 70 -2120 0 0 {name=l3 lab=GND}
C {gnd.sym} 240 -2120 0 0 {name=l4 lab=GND}
...
C {isource.sym} 120 -1500 0 0 {name=I0 value=50u}
C {isource.sym} 220 -1500 0 0 {name=I1 value=50u}
C {vdd.sym} 850 -910 0 0 {name=l10 lab=VDD}
C {gnd.sym} 970 -910 0 0 {name=l11 lab=GND}
C {gnd.sym} 170 -1400 0 0 {name=l6 lab=GND}
...
C {lab_pin.sym} 120 -1570 3 1 {name=p13 sig_type=std_logic lab=I_bias_pos}
C {lab_pin.sym} 220 -1570 3 1 {name=p14 sig_type=std_logic lab=I_bias_neg}
C {vsource.sym} 70 -2260 0 0 {name=V_RF_tone_2
value="sin( 1 1 1 0 )"
savecurrent=true
hide_texts=false}
C {vsource.sym} 240 -2270 0 0 {name=V_RF_b_tone_2
value="sin( 1 1 1 0 0 180 )"
savecurrent=true
hide_texts=false}
C {lab_pin.sym} 70 -2340 1 0 {name=p10 sig_type=std_logic lab=V_RF}
C {lab_pin.sym} 240 -2330 1 0 {name=p11 sig_type=std_logic lab=V_RF_b}
