...
color=4
node=vin_plus}
B 2 1000 -90 1800 310 {flags=graph
y1=0.000871395
y2=0.008871395
ypos1=0
ypos2=2
...
C {code.sym} -100 -550 0 0 {name=spice only_toplevel=false value=
"
...
let v_sig = v(signal_out)
linearize v_sig
let spectrum = fft(v_sig)

plot db(mag(spectrum)) vs fft_scale
write buffer_tb.raw
.endc
