...
C {lab_pin.sym} 700 -570 0 0 {name=p10 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 850 -570 0 0 {name=p11 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 760 -1070 0 0 {name=p19 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 760 -1250 0 0 {name=p20 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 760 -1440 0 0 {name=p21 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 760 -1610 0 0 {name=p22 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 1160 -1350 0 0 {name=p23 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 1850 -1600 3 0 {name=p24 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 2200 -1670 3 0 {name=p25 sig_type=std_logic lab=VSS}
