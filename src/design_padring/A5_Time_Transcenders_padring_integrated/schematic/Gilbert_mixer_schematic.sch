...
N 640 -1680 650 -1680 {
lab=V_LO}
N 880 -1680 1120 -1680 {
lab=#net6}
N 640 -1510 680 -1510 {
lab=V_LO_b}
N 880 -1510 1120 -1510 {
lab=#net5}
N 610 -1320 650 -1320 {
lab=V_RF}
N 880 -1320 1080 -1320 {
lab=#net7}
N 640 -1140 650 -1140 {
lab=V_RF_b}
N 880 -1140 1110 -1140 {
lab=#net8}
N 580 -670 620 -670 {
lab=I_bias}
N 820 -670 880 -670 {
...
lab=#net4}
N 1710 -1880 1710 -1850 {
lab=VDD}
N 1710 -1620 1710 -1590 {
lab=VSS}
N 1200 -1910 1230 -1910 {
lab=VDD}
N 1200 -1950 1200 -1910 {
lab=VDD}
N 1200 -1820 1230 -1820 {
lab=VSS}
...
C {ipin.sym} 610 -1940 2 1 {name=p9 lab=VDD
}
...
C {/home/vasil/Downloads/SSCS_PICO_2025/src/design_padring/Chipathon2025_pads/xschem/symbols/io_secondary_5p0/io_secondary_5p0.sym} 880 -1600 0 1 {name=IO1
spiceprefix=X
}
C {/home/vasil/Downloads/SSCS_PICO_2025/src/design_padring/Chipathon2025_pads/xschem/symbols/io_secondary_5p0/io_secondary_5p0.sym} 820 -590 0 1 {name=IO2
spiceprefix=X
}
C {/home/vasil/Downloads/SSCS_PICO_2025/src/design_padring/Chipathon2025_pads/xschem/symbols/io_secondary_5p0/io_secondary_5p0.sym} 880 -1430 0 1 {name=IO3
spiceprefix=X
}
C {/home/vasil/Downloads/SSCS_PICO_2025/src/design_padring/Chipathon2025_pads/xschem/symbols/io_secondary_5p0/io_secondary_5p0.sym} 880 -1240 0 1 {name=IO4
spiceprefix=X
}
C {/home/vasil/Downloads/SSCS_PICO_2025/src/design_padring/Chipathon2025_pads/xschem/symbols/io_secondary_5p0/io_secondary_5p0.sym} 880 -1060 0 1 {name=IO5
spiceprefix=X
}
C {lab_pin.sym} 740 -740 0 0 {name=p6 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 800 -1210 0 0 {name=p12 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 800 -1390 0 0 {name=p13 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 800 -1580 0 0 {name=p14 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 800 -1750 0 0 {name=p16 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 740 -600 0 0 {name=p7 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 800 -1070 0 0 {name=p10 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 800 -1250 0 0 {name=p15 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 800 -1440 0 0 {name=p17 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 800 -1610 0 0 {name=p19 sig_type=std_logic lab=VSS}
...
m=1
hide_texts=True}
C {lab_pin.sym} 1410 -1140 0 0 {name=p20 sig_type=std_logic lab=VDD}
C {/home/vasil/Downloads/SSCS_PICO_2025/src/design_xsch/5T-OTA-buffer_no_hierarchy.sym} 1780 -1740 0 0 {name=x_Amplifier}
C {lab_pin.sym} 1710 -1880 0 0 {name=p21 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 1710 -1590 0 0 {name=p22 sig_type=std_logic lab=VSS}
