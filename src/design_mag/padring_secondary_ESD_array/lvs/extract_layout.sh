...
gds readonly false
gds rescale true
gds read ../io_secondary_5p0_array.gds

# Check what cells are available and load the flattened one
cellname list allcells
load io_secondary_5p0_array
cellname rename io_secondary_5p0_array ESD_array_layout
...
ext2spice -o netlists/ESD_array_layout.spice
quit
EOF
rm *.ext
